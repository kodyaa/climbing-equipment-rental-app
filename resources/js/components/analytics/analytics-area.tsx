...
export const description = "An interactive area chart for revenue comparison"
...
export function ChartAreaInteractive({ chartData = [] }: ChartAreaInteractiveProps) {
  ...
  const rangeDescription = React.useMemo(() => {
    if (timeRange === "7d") return "Menampilkan data pendapatan 7 hari terakhir"
    if (timeRange === "30d") return "Menampilkan data pendapatan 30 hari terakhir"
    return "Menampilkan data pendapatan 3 bulan terakhir"
  }, [timeRange])
              ...
              content={
                <ChartTooltipContent
                  ...
                  formatter={(value, name) => {
                    ...
                    return (
                      <div className="flex w-full items-center justify-between gap-8 leading-none">
